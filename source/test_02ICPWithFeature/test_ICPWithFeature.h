...
class CICPWithFeature : public CPointcloudBasicProcess
{
public:
	void mainProcess();
	void FreeSpace();

	void GlobalRegistration_FPFH_SAC_IA(string dir_);
	...
	void DoICP_proposed_AllFrames(string dir_);
	...
	void DoEvaluation_ICP_property(string dir_);
