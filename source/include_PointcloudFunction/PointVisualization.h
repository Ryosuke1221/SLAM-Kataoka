...
//private:
	...
	static pcl::PointCloud<pcl::PointXYZRGB>::Ptr drawNumber_OnetoNine_pointcloud(pcl::PointXYZRGB point_center, int num_arg, double length_horizontal_arg)
	{
		//minus atomawashi
	...
	static pcl::PointCloud<pcl::PointXYZRGB>::Ptr expandDiagram(pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud_arg, float times_)
	{
		pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud_(new pcl::PointCloud<pcl::PointXYZRGB>());
...
public:
	...
	pcl::PointCloud<pcl::PointXYZRGB>::Ptr drawLine_pointcloud(pcl::PointXYZRGB point1_, pcl::PointXYZRGB point2_)
	{
	...
	pcl::PointCloud<pcl::PointXYZRGB>::Ptr proliferation_rand(pcl::PointXYZRGB point_arg, int times)
	{
	...
	static bool isPointOutOnLineSegmant(pcl::PointXYZRGB point1_, pcl::PointXYZRGB point2_, pcl::PointXYZRGB point3_)
	{
	...
	static pcl::PointCloud<pcl::PointXYZRGB>::Ptr drawArrow_pointcloud(pcl::PointXYZRGB point_arg, double Roll_, double Pitch_, double Yaw_)
	{
	...
	pcl::PointCloud<pcl::PointXYZRGB>::Ptr drawNumber_pointcloud(pcl::PointXYZRGB point_center, int num_arg)
	{
		pcl::PointCloud<pcl::PointXYZRGB>::Ptr cloud_(new pcl::PointCloud<pcl::PointXYZRGB>());
